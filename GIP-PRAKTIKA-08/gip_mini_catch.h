...
namespace Catch
{
    ...
    public:
        TestCaseInfo(test_fun_ptr_type _test_fun_ptr, std::string _desc,
                     std::string _fun_name, int _line_number) : test_fun_ptr(_test_fun_ptr), desc(_desc),
    ...
    inline void collect_ok(std::string sexpr, std::string fun_name, std::string filename, int line_number)
    {
...
#define REQUIRE(expr)                                             \
    if (expr)                                                     \
    {                                                             \
        Catch::collect_ok(#expr, __func__, __FILE__, __LINE__);   \
    }                                                             \
    else                                                          \
    {                                                             \
        Catch::collect_fail(#expr, __func__, __FILE__, __LINE__); \
    }
}
